...
const corsOptions = {
  origin: 'http://localhost:5173', // Frontend está rodando neste endereço
  credentials: true, // IMPORTANTE: Permite o envio de cookies de autenticação
};
...
sequelize
  .sync({ models: [User, Todo, { model: store.model }], force: true }) // Sincroniza modelos com o banco de dados
  .then(() => {
    app.listen(3001, () => {
